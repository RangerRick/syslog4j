...
public class Log4jSyslogBackLogHandler extends AbstractSyslogBackLogHandler {
	...
	public Log4jSyslogBackLogHandler(final Logger logger) throws SyslogRuntimeException {
		this.logger = logger;

		initialize();
	}

	public Log4jSyslogBackLogHandler(final Logger logger, final boolean appendReason) {
		this.logger = logger;
	...
	public Log4jSyslogBackLogHandler(final Class<? extends SyslogIF> loggerClass) {
		if (loggerClass == null) {
	...
	public Log4jSyslogBackLogHandler(final Class<? extends SyslogIF> loggerClass, final boolean appendReason) {
		if (loggerClass == null) {
			throw new SyslogRuntimeException("loggerClass cannot be null");
		}
	...
	public Log4jSyslogBackLogHandler(final String loggerName) {
		if (loggerName == null) {
	...
	public Log4jSyslogBackLogHandler(final String loggerName, final boolean appendReason) {
		if (loggerName == null) {
			throw new SyslogRuntimeException("loggerName cannot be null");
		}
	...
	public Log4jSyslogBackLogHandler(final String loggerName, final LoggerFactory loggerFactory) {
		if (loggerName == null) {
			throw new SyslogRuntimeException("loggerName cannot be null");
		}
	...
	public Log4jSyslogBackLogHandler(final String loggerName, final LoggerFactory loggerFactory, final boolean appendReason) {
		if (loggerName == null) {
			throw new SyslogRuntimeException("loggerName cannot be null");
		}
	...
	protected static Level getLog4jLevel(final int level) {
		switch(level) {
	...
	public void log(final SyslogIF syslog, final int level, final String message, final String reason) throws SyslogRuntimeException {
		final Level log4jLevel = getLog4jLevel(level);
